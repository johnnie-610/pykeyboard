...
class TestKeyboardBase:
    ...
    def test_add_buttons_single_row(self):
        ...
        buttons = [InlineButton(text="Btn1", callback_data="1"),
    ...
    def test_custom_row_width(self):
        ...
        buttons = [InlineButton(text=f"Btn{i}", callback_data=str(i)) for i in range(1, 6)]
    ...
    def test_method_chaining_combined(self):
        ...
        result = (keyboard
                 .add(*buttons)  # Adds A, B in rows
                 .row(InlineButton(text="C", callback_data="c"))  # Adds C in new row
                 .row(InlineButton(text="D", callback_data="d")))  # Adds D in new row
